...
void Informacion_base_de_datos::on_Recuperar_medida_clicked()
{
    ...
    //Intensidad de luz
    ui-> IntensidadLMax -> setText(QString().sprintf("%f lumen" ,maximo[5]));
    ui-> IntensidadLMin -> setText(QString().sprintf("%f lumen" ,minimo[5]));
    ui-> IntensidadLProm -> setText(QString().sprintf("%f lumen" ,promedio[5]));
